        ...
        if os.path.exists(cached_features_file):
            ...
            for line in textlines:
                ...
                if len(tokenized_text) > max_seq_length - 2:
                    ...
                    tokenized_text.extend([tokenizer.pad_token]*padding_num)
...
def print_preds(batch_inputs, batch_labels, batch_pred_labels, tokenizer):
    ...
    for real_input, real_label, pred_label in zip(real_input_batch_idxs, real_label_batch_idxs, pred_label_batch_idxs):
        ...
        print(real_input.replace(special_token,' '))
        print('\n')
        real_label = ''.join(real_label)
        print(real_label.replace(special_token,' '))
        print('\n')
        pred_label = ''.join(pred_label)
        print(pred_label.replace(special_token,' '))
        print('-'*20)
