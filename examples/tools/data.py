...
def data_split_fastext(data_dir='/data/share/zhanghaipeng/data/lanben_headline/raw_data/', data_name='第一批标题整理(4000条）926版.xlsx'):
    save_dir = '/data/share/zhanghaipeng/lanben_cls/fastText/examples/main/data/'
